"""Application entrypoint and FastAPI app factory for the deep-research service."""
...
from .webserver.routers import alive, health, query, status
...
def get_app() -> FastAPI:
    """Builds and returns the configured deep-research application."""
    configs = get_configs()
